...
$alumnos="SELECT * FROM usuario order by idUsuario";
	...
	<body>
		...
		<section>
				...
				<table class="table">
				  ...
				  echo '<tr>
				    	<td>'.$registroAlumno['idUsuario'].'</td>
				    	<td>'.$registroAlumno['nome'].'</td>
				    	<td>'.$registroAlumno['email'].'</td>
				    	<td>'.$registroAlumno['senha'].'</td>
				    </tr>';
				   }
			...
			<form method="post">
				...
				<table class="table bg-info"  id="tabla">
					<tr class="fila-fija">
						<td><input required name="idUsuario[]" placeholder="ID Alumno"/></td>
						<td><input required name="nome[]" placeholder="Nombre Alumno"/></td>
						<td><input required name="email[]" placeholder="Carrera"/></td>
						<td><input required name="senha[]" placeholder="Grupo"/></td>
			...
			<?php
				...
				while(true) {
				    ...
				    ///////// QUERY DE INSERCIÓN ////////////////////////////
				    $sql = "INSERT INTO usuario (idUsuario, nome, email, senha) 
					VALUES $valoresQ";
