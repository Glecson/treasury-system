...
if (!empty($id_cliente) && is_numeric($id_cliente)):
	...
	$sql = 'SELECT id, nome, email, cpf, data_nascimento, telefone, celular, status, senha, cargo, foto FROM usuario WHERE id = :id';
...
<body>
	<div class='container'>
		<fieldset>
			...
			<?php else: ?>
				<form action="../model/action_cliente.php" method="post" id='form-contato' enctype='multipart/form-data'>
					<div class="row">
				    ...
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="senha" name="senha" value="<?=$cliente->senha?>" placeholder="Infome a Senha">
				    ...
				    <div class="form-group">
				      ...
				      <select class="form-control" name="cargo" id="cargo">
				    	...
				    	<option value="Tisoureiro">Tisoureiro</option>
					  </select>
